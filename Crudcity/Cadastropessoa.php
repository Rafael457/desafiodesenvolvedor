<?php
 include 'conexao/conecta_banco.php';  
  ...
  $Obj_Conexao = new CONEXAO();
	$pega_dados = $Obj_Conexao->Consulta("select max(codpessoa) as total from pessoa" );
	...
	else
	{
		...
		<div align="left">
			<div class="alert alert-info">		
				<form name="formContato" method="get" action="cadPessoa.php">
					<div class="row">
						<div class="col-lg-3">
							<p>
							Nome:
						...
						<div class="col-lg-3">
							...
							<p>
							<input class="btn btn-primary btn-xs" type="date" name="datanasc" id="datanasc" onBlur="VerificaDatanasc(this.value);" required>
							</p>
						</div>
						<div class="col-lg-3">
							<p>
							...
							<p>
							<select class="btn btn-primary btn-xs" name="sexo" required>
						...
						<div class="col-lg-3">
							...
							<p>
							<input class="btn btn-primary btn-xs" type="date" name="datacad" required id="datacad" onBlur="VerificaDatacad(this.value);" required>
							</p>
						</div>
					</div>
					<p>
					...
					<p>
						<input type="number" name="codcli" value="<?=$dados['total']+1?>" disabled>
						<p class="help-block">
							Este campo é preenchido pelo banco de dados.
						</p>
						<input type="hidden" name="codpessoa" value="<?=$dados['total']+1?>">
					</p>
					
					<p>
						<input type="submit" class="btn btn-primary" name="button" id="button" value="Cadastrar Pessoa">
					</p>
				</form>
			</div>
		</div>
